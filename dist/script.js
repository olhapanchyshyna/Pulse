...
function changeModalState(state) {
  var email = document.querySelectorAll('.modal-email'),
...
/* harmony import */ var _modals__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./modals */ "./src/js/modules/modals.js");
...
function forms(state) {
  ...
  function _serverPostData() {
    _serverPostData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url, data) {
      var res;
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      serverPostData('http://localhost:3000/post', json).then(function (data) {
        console.log(data);
        console.log(state);
        thanksTitle.textContent = message.okay;
        windows.forEach(function (item) {
          (0,_modals__WEBPACK_IMPORTED_MODULE_25__.closeModal)(item);
        });
        (0,_modals__WEBPACK_IMPORTED_MODULE_25__.openModal)(thanksModal);
      })["catch"](function () {
      ...
      btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (!btn.closest('.consultation')) {
            ...
            try {
              var cardTitle = document.querySelector(cardTitleSelector).textContent,
                modalTitle = document.querySelector(modalTitleSelector);
              modalTitle.textContent = "".concat(cardTitle);
...
function sliders() {
  ...
  function sliderReviews(slidesItem, sliderWrapperSelector, slidesFiledSelector, sliderReviewsSelector, dotReviewsSelector) {
    var slidesReviews = document.querySelectorAll(slidesItem);
    var sliderWrapperReviews = document.querySelector(sliderWrapperSelector);
    var slidesFiledReviews = document.querySelector(slidesFiledSelector);
    var sliderReviews = document.querySelector(sliderReviewsSelector);
    var dotsReviews = document.querySelectorAll(dotReviewsSelector);
    ...
    function stepSlider() {
      var widthReviews = sliderWrapperReviews.clientWidth + 'px';
      if (window.innerWidth <= 575) {
        ...
        dotsReviews.forEach(function (dot) {
          dot.addEventListener('click', function (e) {
            ...
            slidesFiledReviews.style.transform = "translateX(-".concat(offsetReviews, "px)");
            dotsReviews.forEach(function (dot) {
              dot.style.opacity = '.5';
            });
...
function tabs(btnSelector, tabSelector) {
  ...
  function btnInformation(btnShow, btnHide) {
    var btnInformationShow = document.querySelectorAll(btnShow);
    var btnInformationHide = document.querySelectorAll(btnHide);
    btnInformationShow.forEach(function (btnShow) {
      btnShow.addEventListener('click', function (e) {
        e.preventDefault();
        if (e.target == btnShow) {
          var parent = btnShow.closest('.catalog__item');
          parent.querySelector('.front').style.display = 'none';
          parent.querySelector('.back').style.display = 'flex';
        }
      });
    });
    btnInformationHide.forEach(function (btnHide) {
      btnHide.addEventListener('click', function (e) {
        e.preventDefault();
        if (e.target == btnHide) {
          var parent = btnHide.closest('.catalog__item');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var obj = {};
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(obj);
  (0,_modules_sliders__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])('.catalog__tab', '.catalog__item');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_2__["default"])(obj);
  (0,_modules_mask__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="phone"]');
  (0,_modules_changeModalState__WEBPACK_IMPORTED_MODULE_5__["default"])(obj);
});
})();
